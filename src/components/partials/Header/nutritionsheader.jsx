        ...
        <>
            ...
            <div className="container-fluid offer-main bg-yellow p-0 m-0 d-flex align-items-center">
                <marquee className="text-white py-2">
                    🛍️ If your order is ₹1500 or less, you get a 25% OFF! 💸💥
                    But wait... If your order is above ₹1500, enjoy a massive
                    50% OFF! 🔥🤑 | 💸🛍️ Enjoy exclusive customer support,
                    Monday to Friday, 11 AM to 5 PM! 📞 &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; 🛍️ If your order is ₹1500 or less, you get a 25% OFF!
                    💸💥 But wait... If your order is above ₹1500, enjoy a
                    massive 50% OFF! 🔥🤑 | 💸🛍️ Enjoy exclusive customer
                    support, Monday to Friday, 11 AM to 5 PM! 📞 &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; 🛍️ If your order is ₹1500 or less, you get a
                    25% OFF! 💸💥 But wait... If your order is above ₹1500,
                    enjoy a massive 50% OFF! 🔥🤑 | 💸🛍️ Enjoy exclusive
                    customer support, Monday to Friday, 11 AM to 5 PM! 📞 &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; 🛍️ If your order is ₹1500 or less, you
                    get a 25% OFF! 💸💥 But wait... If your order is above
                    ₹1500, enjoy a massive 50% OFF! 🔥🤑 | 💸🛍️ Enjoy exclusive
                    customer support, Monday to Friday, 11 AM to 5 PM! 📞 &nbsp;
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp;
                    &nbsp; &nbsp; &nbsp; 🛍️ If your order is ₹1500 or less, you
                    get a 25% OFF! 💸💥 But wait... If your order is above
