                    ...
                    <div className="mb-3">
                      ...
                      >
                        ...
                        <div className="arrowIcon d-flex">
                          ...
                          >
                            <path
                              d="M12.95 9.40833L8.23333 4.7C8.15587 4.62189 8.0637 4.5599 7.96215 4.51759C7.8606 4.47528 7.75168 4.4535 7.64167 4.4535C7.53166 4.4535 7.42274 4.47528 7.32119 4.51759C7.21964 4.5599 7.12747 4.62189 7.05 4.7C6.89479 4.85614 6.80767 5.06735 6.80767 5.2875C6.80767 5.50766 6.89479 5.71887 7.05 5.875L11.175 10.0417L7.05 14.1667C6.89479 14.3228 6.80767 14.534 6.80767 14.7542C6.80767 14.9743 6.89479 15.1855 7.05 15.3417C7.12718 15.4204 7.21922 15.4831 7.32078 15.526C7.42234 15.5689 7.53141 15.5912 7.64167 15.5917C7.75192 15.5912 7.86099 15.5689 7.96256 15.526C8.06412 15.4831 8.15616 15.4204 8.23333 15.3417L12.95 10.6333C13.0346 10.5553 13.1021 10.4606 13.1483 10.3552C13.1944 10.2498 13.2183 10.1359 13.2183 10.0208C13.2183 9.90575 13.1944 9.79191 13.1483 9.6865C13.1021 9.58108 13.0346 9.48637 12.95 9.40833Z"
                              fill="#1E1E1E"
                            ></path>
                          </svg>
                        </div>
                      </div>
                      <div class="AppliedDiscount-field">
                        <div class="AppliedCouponText">
                          <div class="flexx">
                            <svg
                              width="40"
                              height="18"
                            ...
                            {totalCouponDiscount !== 0 && (
                              <p
                                className="text-dark m-0 text-bold"
                                style={{ fontSize: "16px" }}
                              >
                                <span className="afsdk_amount_saved">
                                  <b>₹{totalCouponDiscount.toFixed(2)}</b>
                                </span>{" "}
                                saved with{" "}
                                <span className="afsdk_discount_code_applied">
                                  <b>{manualCouponCode || "Coupon Name"}</b>
                                </span>
                              </p>
                            )}
                          </div>
                          ...
                          >
                            <p
                              id="view-all-coupons"
                              class="text-dark viewAllCoupons"
                            >
                              View all coupons
                              <svg
                                width="20"
