                  ...
                  <div className="pricing-item mb-30 regular">
                    <div className="pricing__box text-center">
                      ...
                      <div className="pricing-img">
                        <img src={process.env.PUBLIC_URL + '/assets/images/pricing_01.png'} alt="img" />
                      </div>
                      ...
                      <div className="bottom-img">
                        <img src={process.env.PUBLIC_URL + '/assets/images/pricing_bottom_img.png'} alt="card" />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6 col-sm-9">
                  <div className="pricing-item mb-30 popular-plan">
                    ...
                    <div className="pricing__box text-center">
                      ...
                      <div className="pricing-img">
                        <img src={process.env.PUBLIC_URL + '/assets/images/pricing_02.png'} alt="img" />
                      </div>
                      <div className="pricing-price">
                ...
                <div className="col-lg-4 col-md-6 col-sm-9">
                  <div className="pricing-item mb-30 best-value-plan">
                    ...
                    <div className="pricing__box text-center">
                      ...
                      <div className="pricing-img">
                        <img src={process.env.PUBLIC_URL + '/assets/images/pricing_03.png'} alt="img" />
                      </div>
                      <div className="pricing-price">
                      ...
                      <div className="bottom-img">
                        <img src={process.env.PUBLIC_URL + '/assets/images/pricing_bottom_img.png'} alt="img" />
                      </div>
                    </div>
                  </div>
                </div>
