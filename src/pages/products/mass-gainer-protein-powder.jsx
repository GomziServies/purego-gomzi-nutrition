    ...
    useEffect(() => {
        if (ProductFlavor) {
            if (ProductFlavor.split(" ")[2]) {
                let Flavor =
                    ProductFlavor.split(" ")[1] +
                    " " +
                    ProductFlavor.split(" ")[2];
                ...
                setActiveSize(activesize);
                setCurrentProduct(
                    `${activesize}-${ProductFlavor.split(" ")[1]}`
                );
            }
        }
    }, []);
                            ...
                            <div className="col-lg-7 d-flex align-items-center mt-md-0 p-0">
                                <div className="inner-shop-details-content">
                                    ...
                                    <div className="bg-product px-3 pb-3 pt-3">
                                        ...
                                        <p>
                                            Achieve Your Bulking Goals with Pure
                                            Go Mass Gainer Powder. Our specially
                                            formulated blend is designed to
                                            support muscle growth, weight gain,
                                            and overall performance for
                                            bodybuilders and fitness enthusiasts
                                            seeking to pack on size and strength
                                            effectively.
                                        </p>
                                        <div>
                                            <SelectableList
                                        ...
                                        <h4 className="product-offer-title m-0 d-flex justify-content-md-start justify-content-center align-items-center text-yellow mt-3 me-2">
                                            <img
                                                ...
                                                className="me-1"
                                            />
                                            Hurry! Special Offer Available at
                                            Checkout.
                                        </h4>
                                    </div>
                                    <div className="px-3">
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="product-desc-content">
                                                <h4 className="title">
                                                    Whey Matrix Mass Gainer
                                                    Powder
                                                </h4>
                                                <p>
                                                    Achieve Your Bulking Goals
                                                    with Whey Matrix Mass Gainer
                                                    Powder. Our specially
                                                    formulated blend is designed
                                                    to support muscle growth,
                                                    weight gain, and overall
                                                    performance for bodybuilders
                                                    and fitness enthusiasts
                                                    seeking to effectively pack
                                                ...
                                                <p>
                                                    Our meticulously crafted
                                                    blend provides an optimal
                                                    combination of nutrients for
                                                    maximum results. Each
                                                    serving delivers a powerful
                                                    18 grams of premium protein,
                                                    including a mix of fast and
                                                    slow-digesting proteins,
                                                    ensuring sustained amino
                                                    acid delivery for muscle
                                                    recovery and growth. The
                                                    strategic blend of
                                                    carbohydrates and healthy
                                                    fats provides the necessary
                                                ...
                                                <p>
                                                    Maltodextrin, Skimmed Milk
                                                    Powder, Protein Blend (whey
                                                    protein concentrate, whey
                                                    protein isolate). Cocoa
                                                    powder, Ashwagandha,
                                                    Chocolate Flavour,
                                                    Emulsifier [INS 322(i)],
                                                    Stabilizer [INS 415], BCAA
                                                    blend, Artificial Sweetener
                                                    [INS 955].
                                                </p>
                                                <h4 className="title">
                                                    ALLERGEN ADVICE:
                                                ...
                                                <p>
                                                    Use cool water for a better
                                                    experience. For a thick,
                                                    creamy, and delicious shake,
                                                    use low-fat or Skim Milk.
                                                    Chocolate chips and Nuts can
                                                    be added as per calorie
                                                    intake.
                                                </p>
                                                <h4 className="title">
                                                ...
                                                <p>
                                                    Use the product for at least
                                                    30 days for effective
                                                    results or as suggested by
                                                    your healthcare
                                                    professional.
                                                </p>
                                                <h4 className="title">
                                                ...
                                                <p>
                                                    One serving per day or
                                                    recommended as per a
                                                ...
                                                <p>
                                                    ...
                                                    hygienic place. Keep away
                                                    from direct sunlight. Keep
                                                ...
                                                <p>
                                                    ...
                                                    practitioner prior to use if
                                                    you are pregnant or you have
                                                    liver disease or if you've
                                                    been instructed to follow a
                                                    low-protein diet. Not to
                                                ...
                                                <p>
                                                    Simply mix that can heaping
                                                    scoop (approximately 90
                                                    grams) with 250-300 ml of
                                                    water or milk in a shaker
                                                    bottle or blender until it
                                                    becomes smooth and creamy.
                                                    Enjoy the delicious and
                                                    nutritious shake as part of
                                                    your daily routine to fuel
                                                    your gains effectively.
                                                </p>
                                                <h4 className="title">
                                                    Safe and Trusted:
                                                </h4>
                                                <p>
                                                    ...
                                                    clean and safe supplements
                                                    means our formula is free
                                                    from artificial colors,
                                                    GMOs, banned substances, and
                                                    amino spiking, ensuring only
                                                    the highest quality
                                                ...
                                                <p>
                                                    Trust Pure Go Mass Gainer
                                                    Powder to fuel your gains
                                                    and elevate your performance
                                                    to the next level. With our
                                                    uncompromising commitment to
                                                    quality and taste, each
                                                    shake mixes effortlessly and
                                                    tastes consistently
                                                    delicious, providing you
                                                    with the perfect workout
                                                    companion every time. By
                                                    highlighting these points in
                                                    a more engaging and
                                                    effective manner, potential
                                                    customers are more likely to
                                                    understand the benefits of
                                                    Pure Go Mass Gainer Powder
