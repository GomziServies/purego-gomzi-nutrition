...
function PureGoWheyProtein() {
    ...
    return (
        <>
            <Helmet>
                <title>
                    Top Whey Protein Powder for Muscle Growth & Recovery
                </title>
                <meta
                    name="description"
                            ...
                            <div className="col-lg-7 d-flex align-items-center mt-md-0 p-0">
                                <div className="inner-shop-details-content">
                                    ...
                                    <div className="bg-product px-3 pb-3 pt-3">
                                        ...
                                        <p>
                                            Pure Go Whey Protein is a Mixture of
                                            Whey Protein Isolate, Whey Protein
                                            Concentrate, Skimmed Milk Powder,
                                            Quality Flavours, etc. It is packed
                                            with 28g of 100% High Quality
                                            Protein per serving. The benchmark
                                            and premium source of protein.
                                        </p>
                                        <div>
                                            <SelectableList
                                                items={sizeOptions}
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="product-desc-content">
                                                ...
                                                <p>
                                                    Pure Go Whey Protein is a
                                                    Mixture of Whey Isolate,
                                                    Whey Concentrate, Skimmed
                                                    Milk powder, etc. It is
                                                    packed with 28g of 100% High
                                                    Quality protein per serving
                                                    (35g scoop). The benchmark
                                                    and premium source of
                                                    protein powders. Each
                                                    serving delivers an
                                                    excellent source of
                                                    naturally occurring
                                                    essential amino acids and
                                                    Branch Chain Amino Acids
                                                    (BCAAs). The protein found
                                                    in Performance Whey Blend
                                                    helps support the growth and
                                                    maintenance of lean muscle
                                                    mass, ideal for everyone.
                                                </p>
                                                <h4 className="title">
                                                    INGREDIENTS:
                                                </h4>
                                                ...
                                                <p>
                                                    Add one rounded scoop (35
                                                    gm) of Whey Protein to
                                                    200-250 ml of your favourite
                                                    liquid such as water, skim
                                                    milk or almond milk. Stir
                                                    with a spoon or shake in a
                                                    shaker for 20-25 seconds
                                                    until the protein powder
                                                    fully dissolves.
                                                </p>
                                            </div>
                                        </div>
