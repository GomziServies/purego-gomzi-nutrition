                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              Once your order is placed, our team works
                              diligently to process it within 24 hours. This
                              ensures that your products are carefully packaged
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              We are pleased to offer a standard shipping time
                              of 2 business days for all orders within our
                              delivery areas. Please note that this timeframe
                              begins after your order has been processed and
                              dispatched. We utilize reliable carriers to ensure
                              that your package arrives safely and on time.
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              Standard Shipping: Delivered within 2 business
                              days.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              your location and the size of your order. We
                              strive to provide competitive rates and
                              transparent pricing.
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              a confirmation email containing your tracking
                              number. You can use this number to track your
                              shipment in real-time, ensuring you are always
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              such as a delayed shipment or an incorrect
                              address, please contact our customer service team
                              at gomzinutrition@gmail.com or +91 83200 77993. We
                              are here to assist you and resolve any concerns
                              you may have.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              At Gomzi Life Science, we value your satisfaction.
                              If for any reason you are not completely satisfied
                              with your order, please reach out to us within 30
                              days of receipt. We will do our best to address
