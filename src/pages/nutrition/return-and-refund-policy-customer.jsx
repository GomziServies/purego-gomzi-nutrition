                ...
                <div className="blog--post--item">
                  <div className="blog--post--content blog-details-content">
                    ...
                    <div className="post-text">
                      <p>
                        At Pure Go, we strive to ensure that you are completely
                        satisfied with your purchase. However, we understand
                        that there may be instances where you need to return a
                        product. Please read our Return and Refund Policy
                        carefully.
                      </p>
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              <b>Product Condition:</b> To be eligible for a
                              return, the product must be unopened, unused, and
                              in its original packaging. Products that have been
                              opened or partially used cannot be returned due to
                              health and safety regulations.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Time Frame:</b> Returns must be initiated
                              within 30 days of the purchase date. After this
                              period, we regret that we cannot offer a refund or
                              exchange.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Contact Us:</b> To initiate a return, please
                              contact our customer service team at [customer
                              service email/phone number]. Provide your order
                              number and the reason for the return.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Shipping Costs:</b> Customers are responsible
                              for return shipping costs unless the return is due
                              to an error on our part (e.g., wrong item shipped,
                              defective product).
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Processing Time:</b> Refunds will be processed
                              within 7-10 business days after we receive and
                              inspect the returned item.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Refund Method:</b> Refunds will be issued to
                              the original payment method used for the purchase.
                              Please note that it may take additional time for
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Non-Returnable Items:</b> The following items
                              are non-returnable: Opened or used nutraceutical
                              products. Products purchased from unauthorized
                              retailers.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              <b>Exchanges for Defective Products:</b> If you
                              receive a defective or damaged product, please
                              contact us immediately at [customer service
                              email/phone number]. We will arrange for a
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              Return and Refund Policy at any time. Changes will
                              be effective immediately upon posting on our
                              website.
                            </li>
                          </ul>
                        </div>
