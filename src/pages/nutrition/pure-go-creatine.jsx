                        ...
                        <div class="row">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane show active" id="item-one" role="tabpanel"
                                                ...
                                                <div class="inner-shop-details-img">
                                                    <img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb01.png'} alt="img" />
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="item-two" role="tabpanel" aria-labelledby="item-two-tab">
                                                <div class="inner-shop-details-img">
                                                    <img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb02.png'} alt="img" />
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="item-three" role="tabpanel"
                                                aria-labelledby="item-three-tab">
                                                <div class="inner-shop-details-img">
                                                    <img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb03.png'} alt="img" />
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="item-four" role="tabpanel"
                                                aria-labelledby="item-four-tab">
                                                <div class="inner-shop-details-img">
                                                    <img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb04.png'} alt="img" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link active" id="item-one-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-selected="true"><img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb01.png'} alt="" /></a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link" id="item-two-tab" data-bs-toggle="tab"
                                                    data-bs-target="#item-two" role="tab" aria-controls="item-two"
                                                    aria-selected="false"><img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb02.png'} alt="" /></a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link" id="item-three-tab" data-bs-toggle="tab"
                                                    data-bs-target="#item-three" role="tab" aria-controls="item-three"
                                                    aria-selected="false"><img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb03.png'} alt="" /></a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a href="#" class="nav-link" id="item-four-tab" data-bs-toggle="tab"
                                                    data-bs-target="#item-four" role="tab" aria-controls="item-four"
                                                    aria-selected="false"><img src={process.env.PUBLIC_URL + '/assets/images/shop-details-thumb04.png'} alt="" /></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center">
                                <div class="inner-shop-details-content">
                                    <h4 class="title">Pure-Go Natural Vitamin Supplement</h4>
                                    <div class="inner-shop-details-meta">
                                        <ul class="list-wrap">
                                            <li>Brands : <a href="shop.html">Pure-Go</a></li>
                                    ...
                                    <p>Pure-Go food is food produced by methods complying with the standards of Rrganic farming.
                                    ...
                                    <div class="tab-content" id="myTabContentTwo">
                                        <div class="tab-pane fade show active" id="description" role="tabpanel"
                                            ...
                                            <div class="product-desc-content">
                                                <h4 class="title">The true strength of Pure-Go :</h4>
                                                ...
                                                <h4 class="title">Pure-Go the basics :</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="product-desc-wrap">
                                    <ul class="nav nav-tabs" id="myTabTwo" role="tablist">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link active" id="review-tab" data-bs-toggle="tab"
