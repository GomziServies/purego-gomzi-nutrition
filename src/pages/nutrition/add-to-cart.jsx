                                ...
                                <div className="breadcrumb-content text-center">
                                    ...
                                    <nav aria-label="Breadcrumbs" className="breadcrumb-trail">
                                        <ul className="breadcrumb">
                                            ...
                                            <li className="breadcrumb-item trail-item trail-end"><span>Cart</span></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div className="row">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className="product__thumb">
                                                <a href="shop-details.html"><img src={process.env.PUBLIC_URL + '/assets/images/home_shop_thumb01.png'} alt="" /></a>
                                            </td>
                                        ...
                                        <tr>
                                            <td className="product__thumb">
                                                <a href="shop-details.html"><img src={process.env.PUBLIC_URL + '/assets/images/home_shop_thumb02.png'} alt="" /></a>
                                            </td>
                                            <td className="product__name">
                                        ...
                                        <tr>
                                            <td colspan="6" className="cart__actions">
                                                <form action="#" className="cart__actions-form">
                                                    ...
                                                    <button type="submit" className="btn btn-sm">Apply coupon</button>
                                                </form>
                                                <div className="update__cart-btn text-end f-right">
                                                    <button type="submit" className="btn btn-sm">Update cart</button>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                            ...
                            <div className="col-lg-4">
                                <div className="cart__collaterals-wrap">
                                    ...
                                    <a href="checkout.html" className="btn btn-sm">Proceed to checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
