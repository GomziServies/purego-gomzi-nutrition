                ...
                <div className="blog--post--item">
                  <div className="blog--post--content blog-details-content">
                    ...
                    <div className="post-text">
                      <p>
                        At Pure Go, we strive to provide our customers with
                        transparent and fair pricing for our high-quality
                        nutraceutical products. This Pricing Policy outlines how
                        we determine and display prices on our website,
                        including the inclusion of Goods and Services Tax (GST).
                      </p>
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              ...
                              Inclusive Pricing: All prices listed on our
                              website are inclusive of 18% Goods and Services
                              Tax (GST). This means that the price you see is
                              the total amount you will pay at checkout, with no
                              additional taxes added at that time.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              Currency: All prices are displayed in [insert
                              currency, e.g., USD, INR] and are subject to
                              change without prior notice. The currency will be
                              clearly indicated on the website for your
                              convenience.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              Adjustments: While we aim to maintain consistent
                              pricing, we reserve the right to change our prices
                              at any time due to factors such as supplier costs,
                              demand, or market conditions. Any changes will be
                              reflected on our website.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              Current Prices: The price applicable to your order
                              will be the price displayed at the time of
                              purchase. If there is a discrepancy between the
                              displayed price and the price you are charged,
                              please contact our customer service team for
                              clarification.
                            </li>
                          </ul>
                        </div>
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              Promotional Pricing: From time to time, we may
                              offer discounts, special promotions, or bundle
                              deals. These promotions will be clearly indicated
                              on our website, including the duration and terms
                              of the offer.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              Applicability: Discounts are applied at checkout
                              and will be clearly shown in your order summary.
                              Please note that promotions may be subject to
                      ...
                      <div className="blog-details-wrap border-none">
                        ...
                        <div className="b-details-list">
                          <ul className="list-wrap">
                            <li>
                              <i className="fas fa-check"></i>
                              Accepted Payment Methods: We accept various
                              payment methods for your convenience, including
                              credit/debit cards, digital wallets, and bank
                              transfers. All payment options will be listed at
                              checkout.
                            </li>
                            <li>
                              <i className="fas fa-check"></i>
                              Security: We utilize secure payment gateways to
                              ensure that your payment information is processed
                      ...
                      <p>
                        We are excited to have you on board with Pure Go. Your
                        health and wellness journey is important to us, and we
                        are committed to providing you with the best experience
